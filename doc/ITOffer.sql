...
CREATE TABLE `tb_education` (
    ...
    CONSTRAINT `fk_education_applicant` FOREIGN KEY(`applicant_id`) REFERENCES `tb_applicant`(`applicant_id`)
...
CREATE TABLE `tb_project` (
    ...
    CONSTRAINT `fk_project_applicant` FOREIGN KEY(`applicant_id`) REFERENCES `tb_applicant`(`applicant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目经验表';
...
CREATE TABLE `tb_attachment` (
    ...
    CONSTRAINT `fk_attachment_applicant` FOREIGN KEY(`applicant_id`) REFERENCES `tb_applicant`(`applicant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='简历附件表';