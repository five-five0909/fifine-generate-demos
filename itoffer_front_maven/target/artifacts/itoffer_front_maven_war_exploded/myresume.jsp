            ...
            <div class="resume-section">
                ...
                <div class="section-content clearfix">
                    <div class="profile-pic">
                        <div class="pic-box">
                            <img id="headShotImg" src="${pageContext.request.contextPath}/<c:choose><c:when test='${not empty basicInfo.headShot}'>images/profile/${basicInfo.headShot}</c:when><c:otherwise>images/profile_placeholder.png</c:otherwise></c:choose>" width="120" height="120"/>
                        </div>
                        <form action="${pageContext.request.contextPath}/ResumeServlet" method="post" enctype="multipart/form-data" style="margin-top:10px;" target="_top">
                    ...
                    <div class="info-fields">
                        <form action="${pageContext.request.contextPath}/ResumeServlet" method="post" target="_top">
                    ...
                    <table class="data-table">
                        ...
                        <c:forEach items="${educationList}" var="edu">
                            <tr>
                                ...
                                <td>${edu.major}</td>
                                <td>
                                    <form action="${pageContext.request.contextPath}/ResumeServlet" method="post" style="display:inline;" target="_top">
            ...
            <div class="resume-section">
                ...
                <div class="section-content attachment-placeholder">
                    ...
                    <c:forEach items="${attachmentList}" var="att">
                        <div>
                            <a href="${pageContext.request.contextPath}/${att.filePath}" target="_blank">${att.fileName}</a>
                            <form action="${pageContext.request.contextPath}/ResumeServlet" method="post" style="display:inline;" target="_top">
                    ...
                    <hr/>
                    <h4>上传新附件</h4>
                    <form action="${pageContext.request.contextPath}/ResumeServlet" method="post" enctype="multipart/form-data" target="_top">
