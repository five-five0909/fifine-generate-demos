                                ...
                                <table class="tn-table-grid">
                                    ...
                                    <c:forEach items="${jobList}" var="jobApply">
                                        <tr class="tn-table-grid-row">
                                            ...
                                            <td class="tn-width-auto"><a title="${jobApply.job.company.companyName }" href="CompanyServlet?type=select&id=${jobApply.job.company.companyId }" target="_blank"> ${jobApply.job.company.companyName }</a></td>
                                            <th class="tn-width-pic-mini"><a title="${jobApply.job.jobName }" href="JobServlet?type=select&jobid=${jobApply.job.jobId}" target="_blank"> ${jobApply.job.jobName }</a></th>
                                            ...
                                            <td class="tn-width-action2"><span class="tn-action">
                                                    <a class="tn-action tn-action-text-icon tnui-apply-delete" href="JobServlet?type=delete&applyId=${jobApply.applyId }"> <span class="tn-icon it-icon-delete"></span><span class="tn-action-text">删除</span></a>
                                                </span></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
